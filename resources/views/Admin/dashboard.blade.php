...
<div class="content-header" style="background-color: #dfe8eb;">
...
<!-- /.content-header -->
<style>
  /* Target the calendar lines */
  #calendar table {
    border-color: #4e5557 !important;
  }
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card card-primary">
                            ...
                            <div class="card-body" style="background-color: #dfe8eb;">
                                <div style="width:100%; margin:auto; padding:10px; border:1px solid gray; border-radius:10px; box-shadow:3px 3px 3px gray">
                                    <img class="img-fluid mySlides" src="{{ asset('images/slideshow/1.jpg') }}" style="width:100%">
                                    <img class="img-fluid mySlides" src="{{ asset('images/slideshow/basketball.jpg') }}" style="width:100%">
                                    <img class="img-fluid mySlides" src="{{ asset('images/slideshow/fiesta.jpg') }}" style="width:100%">
                                    <img class="img-fluid mySlides" src="{{ asset('images/slideshow/volleyball.jpg') }}" style="width:100%">
                                    <img class="img-fluid mySlides" src="{{ asset('images/slideshow/araw.jpg') }}" style="width:100%">
                                </div>
